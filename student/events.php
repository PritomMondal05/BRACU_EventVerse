    ...
    <main class="py-5">
        <section class="popular-events py-5 bg-dark text-light">
            <div class="container">
              ...
              <h2 class="mb-4 text-white">All Events</h2>
              <div class="row">
                <?php
...
<div class="col-md-6 col-lg-4 mb-4">
  <div class="card h-100 shadow text-center position-relative" style="background-color: #140A25; color: #fff; border-radius: 20px;">
    ...
    <img src="'.$row['thumbnail'].'" class="card-img-top rounded-top" alt="Club Image" style="border-top-left-radius: 20px; border-top-right-radius: 20px;">
    
    <div class="card-body d-flex flex-column">
      <h5 class="card-title text-white fw-bold">'.$row['name'].'</h5>
      <p class="card-subtitle mb-2 fst-italic text-light-emphasis" style="color: #cccccc;">📅 '.$row['date'].' | ⏰ '.$row['time_slot'].'</p>
      <p class="card-text mt-2 text-light">
        '.substr(strip_tags($row['details']), 0, 100).'...
      </p>
